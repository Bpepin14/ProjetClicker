						...
						<div class="row">
							...
							<div class="col-sm-6">
								...
								<div class="subheader-titles">
									<h2 class="subheader-maintitle">T'inscrires tu devras !</h2>
								</div>
								<!--/ Sub-header titles -->
							</div>
							<!--/ col-sm-6 -->
...
<header class="">
         ...
         <form method="POST" action="">
            <table>
               ...
               <tr>
                  ...
                  <td align="center">
                     <br />
                     <button type="submit" class="btn btn-success" name="forminscription">Validez votre inscription</button> <br/>
                  </td>
               </tr>
            </table>
         </form>
         <br/>  
         <div class="bouton">
         <button type="submit" class="btn btn-info" name="editbutton"><a href="connexion.php" style="color:white">Vous possédez déja un compte ?</a></button> <br/>
         <br/>
