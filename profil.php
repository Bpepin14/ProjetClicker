...
<body class="">
	...
	<div id="page_wrapper">
		...
		<!-- Si session id n'existe pas alors afficher Connexion -->
					...
					<?php } else {  ?>
						...
						<ul class="topnav navRight topnav">
							...
							<li>
								<a href="profil.php">
									<i class="glyphicon glyphicon-log-in visible-xs xs-icon"></i>
									<span class="hidden-xs">Mon profil</span>
...
else if(isset($_GET['pseudo']) OR !empty($_GET['pseudo'])){
   $getpseudo = (isset($_GET['pseudo'])) ? $_GET['pseudo'] : $_SESSION['pseudo'];  
...
?>
     ...
     <header class="bg" style="text-align:center;">
         ...
         {
         ?>
         <img src="images/avatars/<?php echo $userinfo['avatar']; ?>" width="150" /> <br/> <br/> 
