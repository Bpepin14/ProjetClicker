						...
						<div id="search" class="header-search">
							...
							<div class="search-container">
								...
								<input type="hidden" id="q" name="q"/>
									<input name="s" maxlength="20" class="inputbox" type="text" size="20" value="Rechercher ..." onblur="if (this.value=='') this.value='Rechercher ...';" onfocus="if (this.value=='SEARCH ...') this.value='';">
						...
						<div class="row">
							<div class="col-sm-6">
								...
								<ul class="breadcrumbs fixclear">
                                    ...
                                    <li><a href="editionprofil.php">Edition profil</a></li>
									<
								</ul>
								<!--/ Breadcrumbs -->
							...
							<div class="col-sm-6">
								...
								<div class="subheader-titles">
									<h2 class="subheader-maintitle">Mon profil</h2>
								</div>
								<!--/ Sub-header titles -->
							</div>
							<!--/ col-sm-6 -->
         ...
         <div align="center">
            ...
            <table>
               <tr>
                  ...
                  <td>
                     <input type="text" class="form-control" id="pseudo" name="newpseudo" placeholder="Votre pseudo">
                  </td>
               </tr>
               <tr>
                  <td align="right">
                  ...
                  <td>
                     <input type="date" class="form-control" id="datenaissance" name="newdatenaissance">
                  </td>
               </tr>
               <tr>
                  <td align="right">
